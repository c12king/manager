...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=path %>/js/manage/property/tree.js"></script>
	<style type="text/css">
		#u0_img {
                position:absolute;
                left:0px;
 ...
 <script type="text/javascript">
	var path='<%=path %>'
	var proId='${proId}';//被选中的组织机构id
	var proName='${proName}';//被选中的组织机构名称
	var orgId='${proId}';//被选中的组织机构id
