...
$(function(){
	...
	<div style="padding: 20px 20px 40px 30px;">
            ...
            <table>
                        <input name="orgType" id="orgType1" type="hidden" style="width: 150px;" value="${businessUser.orgType}" class="easyui-validatebox"/>
						<input type="hidden" id="userId" name="userId" value="${businessUser.userId}" />
						<input name="positionId" id="positionId1" type="hidden" style="width: 150px;" value="${ businessUser.positionId}" class="easyui-validatebox" />
            			<input name="posName" id="positionName1" type="hidden" style="width: 150px;" value="${ businessUser.posName}" class="easyui-validatebox"/>
					<tr>
			          <td>职位：</td>
			          <td>
			          	<input name="fullPosName" id="orgPosName1" type="text" style="width: 150px;" value="${ businessUser.fullPosName}" class="easyui-validatebox" required="true" missingMessage="请选择职位"  disabled/>
