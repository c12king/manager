...
$(function(){
	...
	<div style="padding: 20px 20px 40px 30px;">
            ...
            <table>
			    ...
			    <input name="orgType" id="orgType" type="hidden" style="width: 150px;" value="" class="easyui-validatebox"/>
			        <tr>
			          <td>真实姓名：</td>
			          <td>
			        ...
			        <tr>
			          <td>部门：</td>
			          <td>
			          	<select name="orgType" id="orgType" class="easyui-validatebox" required="true" missingMessage="请选择部门类型">
