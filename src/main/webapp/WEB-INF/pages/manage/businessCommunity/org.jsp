...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=path %>/js/manage/community/tree.js"></script>
	<style type="text/css">
		#u0_img {
                position:absolute;
                left:0px;
 ...
 <script type="text/javascript">
	var path='<%=path %>'
	var comId='${comId}';//被选中的组织机构id
	var comName='${comName}';//被选中的组织机构名称
	var orgId='${comId}';//被选中的组织机构id
	var type='${type}';//组织机构类型
</script>
