...
<body>
	<div style="padding: 20px 20px 40px 30px;">
            <form id="modifyForm" method="post" action="<%=path %>/manage/businessShopType/update.do">
            <input type="hidden" id="typeId" name="typeId" value="${businessShopType.typeId}" />
            <table>
			        <tr>
			          <td>商铺类型：</td>
			          <td>
			          	<input name="typeName" id="typeName" type="text" style="width: 200px;" maxlength="60" value="${businessShopType.typeName}" class="easyui-validatebox"  required="true" missingMessage="请输入商铺类型名称" />
			          </td>
			        </tr>
            </table>
            </form>
