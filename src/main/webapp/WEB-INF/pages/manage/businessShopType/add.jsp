...
<body>
	...
	<div style="padding: 20px 20px 40px 30px;">
            <form id="addForm" method="post" action="<%=path %>/manage/businessShopType/save.do">
            <table>
			        <tr>
			          <td>商铺类型：</td>
			          <td>
			          	<input name="typeName" id=typeName type="text" style="width: 200px;" value="" maxlength="60" class="easyui-validatebox"  required="true" missingMessage="请输入商铺类型名称" />
			          </td>
			        </tr>
            </table>
            </form>
