...
$(function() {
	...
	grid = $('#grid').datagrid({
        title: '平均活动参与人数',
        iconCls: 'icon-save',
        url: '<%=path %>/statis/operation/averageActivityParticipateList.do',
        fit: true,
        fitColumns: true,
		resize: true,
		//sortName: 'stationId',
        ...
        columns: [[
    		          { field: 'timeField', title: '时间', width: 50, align:'center' },
    		          { field: 'timeValue', title: '平均活动参与人', width: 150, align:'center' }
                ]],
        pagination: false,
        pageNumber: 1,
        pageSize: 10,
