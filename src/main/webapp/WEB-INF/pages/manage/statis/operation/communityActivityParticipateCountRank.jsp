...
$(function() {
	...
	grid = $('#grid').treegrid({
        title: '各社区活动参与总量排名',
        iconCls: 'icon-save',
        url: '<%=path %>/statis/operation/communityActivityParticipateCountRankList.do',
        fit: true,
        fitColumns: true,
		resize: true,
		idField: 'id',
        ...
        columns: [[
					{ title: '时间', colspan:1, align:'center' },
					{ title: '社区参与活动排名', colspan:2, align:'center' }
                   ],[
    		          { field: 'timeField', title: '时间', width: 200, align:'center' },
    		          { field: 'title', title: '社区', width: 400, align:'center' },
    		          { field: 'timeValue', title: '排名', width: 100, align:'center' }
                ]],
        pagination: false,
        //pageNumber: 1,
        //pageSize: 10,
