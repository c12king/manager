...
$(function() {
	...
	grid = $('#grid').treegrid({
        ...
        iconCls: 'icon-save',
        url: '<%=path %>/statis/operation/communityActivityParticipateCountCompareList.do',
        fit: true,
        fitColumns: true,
		resize: true,
		idField: 'id',
