...
$(function() {
	...
	grid = $('#grid').treegrid({
        title: '不同报修分类星级个数',
        iconCls: 'icon-save',
        url: '<%=path %>/statis/property/starByTypeList.do',
        fit: true,
        //fitColumns: true,
		resize: true,
		idField: 'id',
        ...
        columns: [[
					...
					{ title: '分类星级个数', colspan:2, align:'center' }
                   ],[
    		          { field: 'timeField', title: '时间', width: 200, align:'center' },
    		          { field: 'title', title: '分类', width: 200, align:'center' ,
    		          ...
    		          { field: 'timeValue', title: '星级个数', width: 100, align:'center'  }
                ]],
        pagination: false,
        //pageNumber: 1,
        //pageSize: 10,
