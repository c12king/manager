...
<body>
	<div style="padding: 20px 20px 40px 30px;">
            <form id="addForm" method="post" action="<%=path %>/manage/businessStationService/save.do">
           <input name="stationId" id="stationId" type="hidden" style="width: 150px;" value="${stationId}"  />
            <table>
					...
					<tr>
			          <td>服务名称：</td>
			          <td>
			          	<input name="serviceName"  id="serviceName"  style="width: 250px;"   class="easyui-validatebox" required="true" missingMessage="请输入服务名称" />
			          </td>
			        </tr>
					<tr>
			          <td>服务内容：</td>
			          <td>
			          	<input name="content"  id="content" rows="5" cols="18" style="width: 250px;"  class="easyui-validatebox" required="true" missingMessage="请输入服务内容" />
			          </td>
			        </tr>
					<tr>
			          <td>图片路径：</td>
			          <td>
			          	<input name="servicePic" id="servicePic" type="text" style="width: 250px;" value="" class="easyui-validatebox" required="true" missingMessage="图片路径" />
			          </td>
			        </tr>
					<tr>
			          <td>编辑人 ：</td>
