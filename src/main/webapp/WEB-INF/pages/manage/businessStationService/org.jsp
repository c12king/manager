...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=path %>/js/manage/station/tree.js"></script>
	<style type="text/css">
		#u0_img {
                position:absolute;
                left:0px;
 ...
 <script type="text/javascript">
	var path='<%=path %>'
	var staId='${staId}';//被选中的组织机构id
	var staName='${staName}';//被选中的组织机构名称
	var orgId='${staId}';//被选中的组织机构id
