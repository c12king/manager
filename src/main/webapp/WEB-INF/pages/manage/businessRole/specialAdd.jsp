...
<body>
	<div style="padding: 20px 20px 40px 30px;">
            ...
            <table>
            	<input type="hidden" id="resourceRightAdd" name="resourceRightAdd" value="" />
					...
					<tr>
			          <td colspan="2">
			          	<br />
						<input type="button" value="添加特殊权限" onclick="openSpecialComAdd()" />
						</td>
			        </tr>
			        ...
			        <tr>
			          ...
			          <div id="tabs">
							<table id="addResourceRightTable" cellpadding="0" cellspacing="0" style="width: 950px; margin: 0px;padding: 0px;">
								
								<tr style="border: 1px solid;">
									<td style="padding:5px; border: 1px solid #C0C0C0; width: 200px" >资源范围</td>
									<td style="border: 1px solid #C0C0C0;">权限范围</td>
								</tr>
