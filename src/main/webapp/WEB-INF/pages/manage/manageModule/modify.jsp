...
<body>
	<div style="padding: 20px 20px 40px 30px;">
            <form id="modifyForm" method="post" action="<%=path %>/manage/manageModule/update.do">
            <table>
						<input type="hidden" id="moduleId" name="moduleId" value="${manageModule.moduleId}" />
					<tr>
			          <td>模块名称：</td>
			          <td>
			          	<input name="moduleName" id="moduleName" type="text" style="width: 150px;" value="${manageModule.moduleName}" class="easyui-validatebox" required="true" missingMessage="请输入模块名称" validType="reName"/>
			          </td>
			        </tr>
					<tr>
			          <td>模块描述：</td>
			          <td>
			          	<textarea name="moduleDesc"  id="moduleDesc" rows="5" cols="18" class="easyui-validatebox" required="true" missingMessage="请输入模块描述" validType="reDes">${manageModule.moduleDesc}</textarea>
			          </td>
			        </tr>
					<tr>
			          <td>模块图标：</td>
			          <td>
			          	<input name="moduleIcon" id="modifyModuleIconImage" type="hidden" style="width: 150px;" value="${manageModule.moduleIcon}" class="easyui-validatebox"  />
					...
					<tr>
			          <td>模块链接：</td>
			          <td>
			          	<input name="moduleUrl" id="moduleUrl" type="text" style="width: 150px;" value="${manageModule.moduleUrl}" class="easyui-validatebox" required="true" missingMessage="请输入模块链接" validType="maxLength[32]"/>
			          </td>
			        </tr>
            </table>
            </form>
