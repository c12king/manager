...
$(function(){
	...
	<div style="padding: 20px 20px 40px 30px;">
            <form id="modifyForm" method="post" action="<%=path %>/manage/businessTelGroup/update.do">
            <input type="hidden" id="groupId" name="groupId" value="${businessTelGroup.groupId}" />
            <table>
			        <tr>
			          <td>城市ID：</td>
			          <td>
			          	<input name="cityId" id="cityId" type="text" style="width: 150px;" value="${businessTelGroup.cityId}" class="easyui-validatebox"  readonly/>
			        ...
			        <tr>
			          <td>社区ID：</td>
			          <td>
			          	<input name="comId" id="comId" type="text" style="width: 150px;" value="${businessTelGroup.comId}" class="easyui-validatebox"  readonly/>
			          </td>
			        </tr>
			        <tr>
			          <td>小区ID：</td>
			          <td>
			          	<input name="estateId" id="estateId" type="text" style="width: 150px;" value="${businessTelGroup.estateId}" class="easyui-validatebox"  readonly/>
			          </td>
			        </tr>
			        <tr>
			          <td>组名：</td>
			          <td>
			          	...
			          	<input name="groupName" id="groupName" type="text" style="width: 150px;" value="${businessTelGroup.groupName}" class="easyui-validatebox" required="true" missingMessage="请输入小区纬度" />
			        ...
			        <tr>
			          <td>描述：</td>
			          <td>
			          	<input name="memo" id="memo" type="text" style="width: 150px;" value="${businessTelGroup.memo}" class="easyui-validatebox" required="true" missingMessage="请输入小区纬度" />
			          </td>
			        </tr>
            </table>
            </form>
