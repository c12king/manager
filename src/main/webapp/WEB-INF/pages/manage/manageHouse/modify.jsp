...
<body>
	<div style="padding: 20px 20px 40px 30px;">
            <form id="modifyForm" method="post" action="<%=path %>/manage/manageHouse/update.do">
            <table>
						<input type="hidden" id="houseId" name="houseId" value="${manageHouse.houseId}" />
					<tr>
			          <td>门号：</td>
			          <td>
			          	<input name="houseNo" id="houseNo" type="text" style="width: 150px;" value="${manageHouse.houseNo}" class="easyui-validatebox" required="true" missingMessage="请输入门号" validType="reName"/>
			          </td>
			        </tr>
            </table>
            </form>
