...
$(function() {
	...
	grid = $('#grid').datagrid({
        ...
        iconCls: 'icon-save',
        url: '<%=path %>/app/appStatisticsClick/expressSendList.do',
        fit: true,
        fitColumns: true,
		resize: true,
		//sortName: 'stationId',
        ...
        columns: [[
    		          { field: 'timeField', title: '人数', width: 50, align:'center' },
    		          { field: 'timeValue', title: '次数', width: 150, align:'center' }
                ]],
        pagination: false,
        pageNumber: 1,
        pageSize: 10,
			        ...
			        <tr>
			          ...
			          <td>
			          	...
			          	<select name="scope" id="scope">
			          		 <option value="0" selected >app</option>
							 <option value="1">快递</option>
							 <option value="2">二手统计</option>
							 <option value="3">邻里求助</option>
							 <option value="4">中医养生</option>
							 <option value="5">健康饮食</option>
							 <option value="6">北青社区报</option>
							 <option value="7">社区活动</option>
							 <option value="8">驿站服务</option>
							 <option value="9">驿站女孩</option>
							 <option value="10">驿站公告</option>
							 <option value="11">物业通知</option>
							 <option value="12">物业手册</option>
							 <option value="13">小区周边</option>
							 <option value="14">社区黄页</option>
							 <option value="15">首页</option>
							 <option value="16">新闻</option>
			          	</select>
			          	搜索
			          </td>
			        </tr>
